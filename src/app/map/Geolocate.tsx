...
// Current Progress: 12/7/2023
// This is styled correctly but i can't click on it
// also a bunch of type errors here
// from vercel
// this line: ctrl.on("loading", props.onLoading); triggers the below error
// Type error: Argument of type '((e: object) => void) | undefined' is not assignable to parameter of type '(...args: any[]) => void'.
